...
describe('RecoveryCodesDialog', () => {
  it('shows one-time recovery codes as selectable text', () => {
    const wrapper = mount(RecoveryCodesDialog, { ...withChineseI18n(), props: { open: true, codes: ['A1-B2', 'C3-D4'] } })
  ...
  it('only acknowledges after the checked user action and never emits a generic close', async () => {
    const wrapper = mount(RecoveryCodesDialog, { ...withChineseI18n(), props: { open: true, codes: ['A1-B2'] } })
